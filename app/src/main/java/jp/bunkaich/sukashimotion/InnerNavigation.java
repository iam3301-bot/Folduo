...
final class InnerNavigation {
    ...
    InnerNavigation(Context c,int display,int width,int height,Actions actions){context=UiText.localizedWindow(c);displayId=display;this.width=width;this.height=height;this.actions=actions;wm=c.getSystemService(WindowManager.class);collapse();}
